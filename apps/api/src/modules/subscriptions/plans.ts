import type { PlanDto, PlanKey, FeatureKey } from '@pharmaos/shared';
...
/**
 * Plan catalogue. Limits and features are enforced server-side (entitlement middleware and
 * limit checks in services). Prices are indicative until billing is connected.
 */
