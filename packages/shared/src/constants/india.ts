...
/** GSTIN format: 2-digit state, 10-char PAN, 1 entity code, 'Z', 1 checksum. */
export const GSTIN_REGEX = /^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}Z[0-9A-Z]{1}$/;
export const PAN_REGEX = /^[A-Z]{5}[0-9]{4}[A-Z]{1}$/;
export const INDIAN_PHONE_REGEX = /^(\+91[-\s]?)?[6-9]\d{9}$/;
export const PINCODE_REGEX = /^[1-9][0-9]{5}$/;

/** Common GST slabs in basis points. */
export const GST_RATE_OPTIONS_BPS = [0, 500, 1200, 1800, 2800] as const;
