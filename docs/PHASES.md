...
- [x] Onboarding: a curated list of ~100 common medicines and counter items at `/products/starter`, pre-ticked with the essentials, so a new pharmacy fills its catalogue in one click instead of typing each product. Prices stay blank by design; duplicates are detected and skipped.
